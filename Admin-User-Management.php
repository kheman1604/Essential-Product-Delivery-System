...
<body ng-app="Adminmodule" ng-controller="Admincontroller">
    ...
    <div id="overall-container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="Admin-Dash.php" style="font-size:20px; font-weight:500; color:lightgrey;"><i class="fa fa-tachometer" style="font-size:20px; "></i> &nbsp;Admin Dashboard</a>
                    </li>
                     <li class="nav-item active">
                        <a class="nav-link" href="logout-process.php" style="font-size:20px; font-weight:500; color:lightgrey;">Logout</a>
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <div class="btn btn-success" ng-click="doFetch();">Fetch Records</div>
        ...
        <table width="90%" class="table table-striped" class="table">
            ...
            <tr ng-repeat="obj in jsonarray">
                ...
                <td>
                    <div class="btn btn-danger" ng-click="doBlock(obj.uid);">Block</div>
                </td>
                <td>
